...
// declaring a struct
type IdiotmouthDictionary struct {
...
func (d *IdiotmouthDictionary) generate(minWordLength int) {
...
func (d *IdiotmouthDictionary) generateDictionary(minWordLength int) {
...
func (d *IdiotmouthDictionary) generateLetters() {
...
func (d *IdiotmouthDictionary) generateFreqs() {
...
func (d *IdiotmouthDictionary) getWorth(letters string) int {
